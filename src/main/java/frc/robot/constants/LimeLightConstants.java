...
public class LimelightConstants {
    ...
    public static final double BACK_LL_VERTICAL_ANGLE_DEG = 0;

    //BACK HEIGHT FROM FLOOR
    public static final double BACK_LL_X_OFFSET_INCHES = 8;

    //BACK DISTAMCE FROM CENTER OF BOT IN THE Y DIMENSION
    public static final double BACK_LL_Y_OFFSET_INCHES = 12;

    //BACK HEIGHT FROM FLOOR
    public static final double BACK_LL_HEIGHT_OFFSET_INCHES = 8;
